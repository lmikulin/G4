function draw(){
        ...
        var size = (document.getElementById('size').value.length>0) ? document.getElementById('size').value : DEFAULT_SIZE;
        var range = (document.getElementById('range').value.length>0) ? document.getElementById('range').value : DEFAULT_RANGE;
